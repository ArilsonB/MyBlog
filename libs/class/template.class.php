        ...
        public function loadPosts(){
            ...
            if(count($m[1]) > 0){
                ...
                foreach($query as $row){
                    ...
                    if($row["author"] > 0){
                        $author = $this->conn->select('users','fullname',"id = $row[author]");
                        $pauthor = $author ? $author : 'Unknow';
                    }else{
                        $pauthor= "MyBlog Team";
                    }
                ...
                if(!$date || !$postname){
                    ...
                    foreach($posts as $row){
                        ...
                        if($date == $pdate){
                            ...
                            $this->__set('blog:page',$row['title']);
                            $varToRep = array("%post:title%","%post:date%","%post:author%","%post:exerpt%","%post:content%");
